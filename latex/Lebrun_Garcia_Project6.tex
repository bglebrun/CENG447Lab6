...
\begin{itemize}
    ...
    \item motor_driver.h - Motor driver header from lab 5
    \item motor_driver.c - Motor driver code from lab 5
    ...
    \item pin_map.h - Pin map header for device
...
\section*{Appendix B: motor_driver.h}
\begin{tiny}
\lstinputlisting{../motor_driver.h}
\end{tiny}
\newpage

\section*{Appendix C: motor_driver.c}
\begin{tiny}
